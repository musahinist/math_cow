...
class DatabaseHelper {
  String serverUrl = "http://mathcow.herokuapp.com";
  var status;

  var token;

  loginData(String name, String email, String password) async {
    String myUrl = "$serverUrl/api/users";
    ...
    //var datah = json.decode(response.headers.toString());
